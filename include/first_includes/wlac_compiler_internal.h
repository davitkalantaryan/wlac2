// 
// file:			include/first_includes/wlac_compiler_internal.h
// created on:		2020 Feb 23
// created by:		D. Kalantaryan (davit.kalantaryan@desy.de)
//

#ifndef WLAC_INCLUDE_ADDITIONAL_FIRST_INCLUDES_WLAC_COMPILER_INTERNAL_H
#define WLAC_INCLUDE_ADDITIONAL_FIRST_INCLUDES_WLAC_COMPILER_INTERNAL_H
...
#define CONST_CAST2(_type,_dataToConvert)                               const_cast<_type>(_dataToConvert)
...
#define CONST_CAST2(_type,_dataToConvert)                               ((_type)(_dataToConvert))
...
#ifdef WLAC_CREATING_DYNAMIC_LIB
#define WLAC_EXPORT      EXPORT_FROM_LIB2
#elif defined(WLAC_USING_STATIC_LIB_OR_SOURCES)
#define WLAC_EXPORT
#else
#define WLAC_EXPORT      IMPORT_FROM_LIB2
#endif


#endif  // #ifndef WLAC_INCLUDE_ADDITIONAL_FIRST_INCLUDES_WLAC_COMPILER_INTERNAL_H
