...
#ifdef DISABLE_SOME_WARNINGS
#pragma warning(disable : 4133)
#endif

void sun_rpc_report(const char*);  /// Added by DK
//int bindresvport(int sd, struct sockaddr_in * sin); /// Added by DK
//int gettimeofday(struct timeval *tv, struct timezone *tz); /// Added by DK
...
#if 0
struct clnt_ops {
	enum clnt_stat(*cl_call)(CLIENT *, u_long, xdrproc_t, caddr_t, xdrproc_t, caddr_t, struct timeval);	/* call remote procedure */
	void(*cl_abort)(CLIENT *);	/* abort a call */
	void(*cl_geterr)(CLIENT *, struct rpc_err *);	/* get specific error code */
	bool_t(*cl_freeres)(CLIENT*, xdrproc_t, caddr_t); /* frees results */
	void(*cl_destroy)(CLIENT *);/* destroy this structure */
	bool_t(*cl_control)(CLIENT*, u_int, char*);/* the ioctl() of rpc */
} *cl_ops;
#endif
